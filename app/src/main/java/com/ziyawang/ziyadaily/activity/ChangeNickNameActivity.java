...
import com.ziyawang.ziyadaily.views.EmojiEditText;
...
public class ChangeNickNameActivity extends BenBenActivity implements View.OnClickListener {
    ...
    private void submitUserName() {
        ...
        if (judge()){
            dialog = new MyProgressDialog(ChangeNickNameActivity.this , "正在为您修改昵称...") ;
            dialog.show();
            String urls = String.format(Url.ChangeNickName , GetBenSharedPreferences.getTicket(this)) ;
            HttpUtils httpUtils = new HttpUtils() ;
            RequestParams params = new RequestParams() ;
            params.addBodyParameter("name", changeUserName_editText.getText().toString().trim() );
