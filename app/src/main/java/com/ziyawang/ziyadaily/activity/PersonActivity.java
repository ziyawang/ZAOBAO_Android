...
public class PersonActivity extends BenBenActivity implements View.OnClickListener {
    ...
    private void iconGet() {
        ...
        camera.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ActivityCompat.checkSelfPermission(PersonActivity.this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
                    ToastUtils.shortToast(PersonActivity.this, "请在管理中心，给予相机相应权限。");
                    window.dismiss();
                }else {
        ...
        switch (requestCode) {
            case 1:
                if (resultCode == RESULT_OK && null != data) {
                    ...
                    Toast.makeText(PersonActivity.this, "请重新选择图片", Toast.LENGTH_SHORT).show();
                }
                break;
            case 2:
                if (resultCode == Activity.RESULT_OK) {
                    ...
                    Toast.makeText(PersonActivity.this, "请重新获取图片", Toast.LENGTH_SHORT).show();
                }
                break;
            case 3:
                if (resultCode == Activity.RESULT_OK) {
                    ...
                    if (extras != null) {
                        ...
                        String urls = String.format(Url.upload, GetBenSharedPreferences.getTicket(PersonActivity.this)) ;
                        ...
                        utils.send(HttpRequest.HttpMethod.POST, urls, params, new RequestCallBack<String>() {
                            ...
                            public void onSuccess(ResponseInfo<String> responseInfo) {
                                Log.e("ChangeIcon", responseInfo.result);
                                try {
                                    JSONObject jsonObject = new JSONObject(responseInfo.result);
                                    String status_code = jsonObject.getString("status_code");
                                    switch (status_code) {
                                        case "200":
                                            ToastUtils.shortToast(PersonActivity.this, "更换头像成功");
                                            my_icon.setImageBitmap(bitmap);
                                            break;
                                        default:
                                            ToastUtils.shortToast(PersonActivity.this, "更换头像失败");
                                            break;
                                    }
                                } catch (JSONException e) {
                                    e.printStackTrace();
                                    ToastUtils.shortToast(PersonActivity.this, "网络连接异常");
                                }
                            }
            ...
            case 12:
                if (resultCode == Activity.RESULT_OK && null != data ) {
                    ...
                    Toast.makeText(PersonActivity.this, "请重新修改昵称", Toast.LENGTH_SHORT).show();
                }
                break;
            default:
                break;
    ...
    private void goChangeNickNameActivity() {
        Intent intent = new Intent(PersonActivity.this ,ChangeNickNameActivity.class  ) ;
        intent.putExtra("username" , userName.getText().toString() ) ;
        startActivityForResult(intent, 12);
    }

    private void goChangePwdActivity() {
        Intent intent = new Intent(PersonActivity.this, ChangePwdActivity.class);
